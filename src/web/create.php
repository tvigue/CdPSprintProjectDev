...
if(isset($_POST['id_atelier'])){
  ...
  $sql ="UPDATE Ateliers SET name_atelier = '$nom', theme_atelier = '$theme' ,type_atelier = '$type',lieu_atelier ='$lieu',
  duree_atelier = '$duree',horaire_atelier ='$horaire',capacite ='$capacite' ,inscription = '$inscription'
...
header('Location: http://localhost/Project/listeAtelier.php');
?>
