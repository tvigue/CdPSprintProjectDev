<?php
if(isset($_POST['id_atelier']))      $id_atelier=$_POST['atelier'];
$id_atelier = 0;
// connexion à la base
      ...
      <form action="create.php" method="post" >
        <table class="table_formulaire">
          <tr>
            ...
            <td><input type="text" name="nom" value="<?php if(isset($row['name_atelier'])) echo $row['name_atelier'];?>" /></td>
          </tr>
          <tr>
            <td>Theme</td>
          ...
          <tr>
            <td>Nb de place</td>
            <td><input type="number" name="capacite" min="0" value="1" value="<?php if(isset($row['capacite'])) echo $row['capacite'];?>" )/></td>
          </tr>
          <tr>
            <td>Inscription</td>
            <td><input type="checkbox" name="inscription" value="<?php if(isset($row['inscription'])) echo $row['inscription'];?>" /></td>
          </tr>
          <tr>
            <?php
            if(isset($id_atelier)){
